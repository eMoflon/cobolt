...
public class EdgePropertyDelta<T> extends EdgeDelta implements IGraphElementPropertyDelta<T> {

	private final SiSType<T> property;
	private final T oldValue;

	public EdgePropertyDelta(final SiSType<T> property, final T oldValue, final IEdge edge, final Timestamp timestamp) {
