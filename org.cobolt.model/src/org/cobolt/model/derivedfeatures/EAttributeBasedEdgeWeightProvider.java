...
/**
 * An {@link EdgeWeightProvider} that calculates the weight of an {@link Edge}
 * based on a given (double-valued) {@link EAttribute} and an additional
 * function
 * 
...
public class EAttributeBasedEdgeWeightProvider implements EdgeWeightProvider {
	...
	/**
	 * Returns the edge weight, which is calculated by (i) extracting this
	 * provider's configured attribute from the given edge and (ii) applying the
	 * configured function to this value
	 * 
	 * The given edge is not modified
	 * 
	 * @param edge
	 *            the edge of which the weight shall be determined
	 */
	@Override
