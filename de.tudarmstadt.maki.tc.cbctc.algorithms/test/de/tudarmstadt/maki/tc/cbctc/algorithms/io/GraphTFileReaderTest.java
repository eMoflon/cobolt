...
public class GraphTFileReaderTest {
	...
	public void testWithTestgraphD1() throws Exception {
		...
		Assert.assertEquals(22.0, link34.getWeight(), TopologyTestUtils.EPS_0);

		final Edge revLink34 = link34.getReverseEdge();
		Assert.assertEquals(22.0, revLink34.getWeight(), TopologyTestUtils.EPS_0);
   ...
   public void testWithTestgraphE1() throws Exception {
   	...
   	Assert.assertEquals(10, topology.getNodeById("n1").getEnergyLevel(), TopologyTestUtils.EPS_6);
   	Assert.assertEquals(2, topology.getEdgeById("e12").getExpectedLifetime(), TopologyTestUtils.EPS_6);
   	Assert.assertEquals(1, topology.getEdgeById("e13").getExpectedLifetime(), TopologyTestUtils.EPS_6);
   	Assert.assertEquals(2, topology.getEdgeById("e23").getExpectedLifetime(), TopologyTestUtils.EPS_6);
