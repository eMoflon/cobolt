...
public class LStarKTCHelper {
	 ...
	 * @param hopCount3
	 * @param a
	 *            see UnderlayTopologyControlAlgorithms#LSTAR_KTC_PARAM_A
	 * @return whether the predicate is fulfilled
	 */
	public static boolean checkPredicate(final int hopCount1, final int hopCount2, final int hopCount3,
			final double a) {
